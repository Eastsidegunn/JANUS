...
func TestValidateRecordValid(t *testing.T) {
	...
	cases := map[string]string{
		...
		"subagent/spawn local extension one":     envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"확장","depth":1,"budget":{"tokens":100,"time_ms":1000,"max_depth":2},"world_backend":"local-podman","profile_id":"sandbox-default","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/workspace/source","target_path":"/workspace","mode":"overlay","upper_ref":"world/trace/span/overlay/upper"}],"extensions":[{"name":"mcp-a","version":"1.2.3","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"subagent/spawn local extensions sorted": envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"확장","depth":1,"budget":{"tokens":100,"time_ms":1000,"max_depth":2},"world_backend":"local-podman","profile_id":"sandbox-default","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/workspace/source","target_path":"/workspace","mode":"overlay","upper_ref":"world/trace/span/overlay/upper"}],"extensions":[{"name":"mcp-a","version":"1.2.3","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"},{"name":"mcp-b","version":"1.0.0","integrity":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","source":"registry.example","artifact_digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"}]}`),
...
func TestValidateRecordInvalid(t *testing.T) {
	...
	cases := map[string]string{
		...
		"spawn none에 extensions":                   envelope(`"kind":"subagent/spawn","payload":{"adapter":"null","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"none","extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension artifact_digest 누락": envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example"}]}`),
		"spawn local extension integrity md5":      envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"md5:abc","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension integrity short":    envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:abc","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension version 누락":         envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension duplicate":          envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"},{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension reverse order":      envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"b","version":"1.0.0","integrity":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","source":"registry.example","artifact_digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},{"name":"a","version":"1.2.3","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`),
		"spawn local extension unknown field":      envelope(`"kind":"subagent/spawn","payload":{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `","token":"secret"}]}`),
...
func TestValidateEventRejectsExtensionSpawnKindNotPayload(t *testing.T) {
	v := newV(t)
	payload := `{"adapter":"claude-code","instruction":"x","depth":0,"budget":{"tokens":1,"time_ms":1,"max_depth":1},"world_backend":"local-podman","profile_id":"p","image_digest":"sha256:` + hex64 + `","mounts":[{"source_path":"/src","target_path":"/workspace","mode":"overlay","upper_ref":"u"}],"extensions":[{"name":"a","version":"1.0.0","integrity":"sha256:` + hex64 + `","source":"registry.example","artifact_digest":"sha256:` + hex64 + `"}]}`
	if err := v.ValidateRecord([]byte(envelope(`"kind":"subagent/spawn","payload":` + payload))); err != nil {
