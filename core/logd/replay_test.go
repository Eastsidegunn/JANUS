...
func TestReplayMessagesProjection(t *testing.T) {
	...
	events := []gen.EventRecord{
		...
		mkEvent(7, gen.KindSubagentSpawn, "parent", child, `{"adapter":"null","instruction":"test","depth":0,"budget":{"tokens":100,"time_ms":1000,"max_depth":1},"world_backend":"none","control_mode":"tool_approval"}`),
