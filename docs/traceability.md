...
| T8 준비 — 픽스처 비밀 검사 게이트 fail-closed 3분기 (무검출 0 / 검출 1 / 대상 부재·인자 누락·grep 오류 2) | `tools/fixturecheck/script_test.go` (TestSecretCheckGate — 6케이스, `tools/check-fixture-secrets.sh` 실행) | T8 | green |
